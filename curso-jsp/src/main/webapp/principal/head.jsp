...
<head>
<title>Projeto aula - <%= session.getAttribute("usuario")%> </title>
<meta charset="utf-8">
<meta name="viewport"
	content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
<meta name="description" content="Projetos feito em JSP" />
<meta name="author" content="Willian R. Juliate" />
...
<link href="https://fonts.googleapis.com/css?family=Roboto:400,500"
	rel="stylesheet">
<!-- waves.css -->
<link rel="stylesheet" href="<%= request.getContextPath() %>/<%= request.getContextPath() %>/assets/pages/waves/css/waves.min.css"
